...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, meta = (Keywords = "AndroidAPI ", DisplayName = "Does Phone Have Accel"), Category = "AndroidAPI")
		static bool AndroidAPITemplate_DoesPhoneHaveAccel();
};
